  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8">
        ...
        {/* ── Preview con scroll ───────────────────────────────────────────── */}
        <div className="overflow-x-auto p-6 bg-stone-50">
          <DocumentPreview ref={previewRef} documento={documento} totales={totales} />
        </div>

        {/* ── Error ────────────────────────────────────────────────────────── */}
        {error && (
          <div className="mx-6 mb-4 flex items-start gap-2 p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700">
