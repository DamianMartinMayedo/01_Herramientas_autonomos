...
export const DocumentPreview = forwardRef<HTMLDivElement, DocumentPreviewProps>(
  ({ documento, totales }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className="bg-white w-[210mm] h-[297mm] p-10 text-stone-800 text-sm font-sans relative overflow-hidden"
      >
        {/* ── Contenido principal (con padding-bottom para no solapar el footer) */}
        <div className="pb-10">
        ...
        {/* ── FOOTER DE MARCA — siempre al pie del A4 ──────────────────────── */}
        <div className="absolute bottom-0 left-0 right-0 px-10 pb-6 pt-3 border-t border-stone-100 text-center">
