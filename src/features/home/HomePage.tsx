...
import { FileText, Calculator, ArrowRight, AlertTriangle, BookOpen, Calendar, Tag } from 'lucide-react'
...
export function HomePage() {
  ...
  const blogPosts = allPosts.filter((p) => p.status === 'published').slice(0, 3)
